...
export const PLANS: PlanInfo[] = [
  ...
  },
  {
    ...
    price: 24900,
    features: [
      'Неограниченно меню и блюд',
      '3 языка меню (RU / KZ / EN)',
      'Аналитика — 90 дней',
      'Стоп-лист и поиск',
      'Все AI функции (перевод, КБЖУ, описания)',
      'Аллергены',
      'Telegram сводка',
      'Убрать брендинг "Powered by qrmenus.kz"',
    ],
    features_soon: ['Кастомный домен', 'Поддержка 2ч'],
  },
]
